...
public class CharacterParser {
	...
	public static String getFristLetter(String chs){
		// 汉字转换成拼音
		String pinyin =getPinyin(chs);
		String fristLetter = pinyin.substring(0, 1).toUpperCase();
		return fristLetter.matches("[A-Z]")?fristLetter:"#";
	}
