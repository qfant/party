...
public class GridHalfDecoration extends RecyclerView.ItemDecoration {

    private Drawable mDivider;

    public GridHalfDecoration(Context context) {
        this(context, R.drawable.pub_white_line_5);
    }

    public GridHalfDecoration(Context context, int resId) {
...
//        drawTop(c, parent);
    ...
    public void getItemOffsets(Rect outRect, int itemPosition, RecyclerView parent) {
        ...
        } else if (isLastColum(parent, itemPosition, spanCount, childCount)) {// 如果是最后一列，则需要绘制右边
