...
public class FeeMonthFragment extends BaseFragment implements SwipRefreshLayout.OnRefreshListener {
    ...
    private void startRequest(int pager) {
        ...
        param.pageNo = pager;
        Request.startRequest(param, pager, ServiceMap.wuyeFeeMonths, mHandler);
    }
    ...
    private void setListView() {
        adapter = new MultiAdapter(getContext()).addTypeView(new ITypeView() {
            ...
            public BaseViewHolder createViewHolder(Context mContext, ViewGroup parent) {
                return new FeeMonthHolder(mContext, LayoutInflater.from(mContext).inflate(R.layout.pub_fragment_feemonth_item_layout, parent, false));
            }
        });
    ...
    public boolean onMsgSearchComplete(NetworkParam param) {
        if (param.key == ServiceMap.wuyeFeeMonths) {
            FeeMonthResult result = (FeeMonthResult) param.result;
